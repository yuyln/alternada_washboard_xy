module variaveis
    ...
    integer, parameter:: ni = 5000, ns = 2, np = 7, nc = 3000, &
&                        corte = 1, relax = 0
    ...
    &                            u = 1.d0, rp = 0.65d0, &
    &                            hc = fcf / nc
    doubleprecision, parameter:: nac = 10000.d0, omega = dble(nac) / dble(ni)
...
&                                beta = betadamp * damping
    ...
    doubleprecision:: fcx, fcy, aux, hx, hy, wy, hxs, hys, wx
...
module gera_function
    ...
    doubleprecision, dimension(0: n):: y_bessel, y_wash, y_wash2
    ...
    doubleprecision function tab_wash2(x)
        implicit none
        integer:: index_
        doubleprecision:: x
        if (x > bw) then
...
subroutine forcas(desx, desy)
    ...
    do i___ = -1, 1
        ...
        enddo
    enddo
    call skyr_wash(y0(i_s) + desy, tab_wash2, wy)
